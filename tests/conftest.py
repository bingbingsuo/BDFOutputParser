...
def bohr_geometry_output():
    """Bohr 坐标系几何 — BDF 输出格式: elem, x, y, z, charge"""
    return """
 Atom  Cartcoord(Bohr)

 Atom   Charge   Basis
 ------------------------------------------------------------------------
   C        1.12766281      -0.06079459       1.22640622     6.00
   N       -0.48840199       0.98939510      -0.44852350     7.00
   H        2.09856789       0.11890456       1.00345678     1.00
   H        0.75689012      -0.84056789       1.88901234     1.00
